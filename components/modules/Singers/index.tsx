...
const Singers: FC<SingersProps> = ({ isTopNav }) => {
  return (
    <div className={`my-24 bg-white flex flex-col mr-5 border shadow-lg rounded-lg  ${isTopNav && "my-40"} transition-all`}>
      <div className="flex justify-between items-center px-5 py-5 border-b border-gray-200">
        ...
        <Link href="/admin/addnewsong">
          <button className="bg-primary text-white px-4 py-2 rounded-2xl mobilesm:text-xs">Add New Singer</button>
        </Link>
      </div>
              ...
              return (
                <tr key={index}>
                  ...
                  <td className="border mx-0 flex justify-center items-center">
                    <img src="https://templates.iqonic.design/muzik/html/images/user/04.jpg" className="w-16 h-16 m-2 rounded-2xl" alt={`${index}_singer`} />
                  </td>
                  <td className="border px-5">galiendcodes13@gmail.com</td>
                  <td className="border px-5">Lorem ipsum dolor sit amet consectetur adipisicing elit. Laborum, quasi.</td>
