...
import { VDots, VStar } from "../Vectors";
...
const NewReleases = () => {
  ...
  return (
    <div className="mt-20 mr-5 bg-white shadow-lg rounded-bl-[3.125rem]">
      <p className="text-2xl py-5 px-5 bg-white text-gray-700 font-bold">New Release</p>
      <div className="w-full relative overflow-hidden h-[30rem] rounded-bl-[3.125rem] shadow-xl text-white">
        <img src={liveBg.src} alt="live background" className="absolute h-full w-full object-cover rounded-tr-[3.125rem] rounded-bl-[3.125rem]" />
          ...
          <div className="flex h-[8rem] pb-5 flex-col justify-between lg:h-full ">
            ...
            <div className="lg:block hidden">
              <div className="mx-2 py-1 mr-20">
                <AudioPlayer tracks={songs} isMinified={true} className="w-10 h-10" />
              </div>
            </div>
          </div>
                ...
                >
                  <div className="flex items-center space-x-4">
                    <div className="lg:w-[3.75rem] lg:h-[3.75rem] max-h-20 w-12 h-12 rounded-br-2xl rounded-tl-2xl overflow-hidden">
                      <img src={item.img} className="object-cover" alt={item.title} />
                    </div>
                  ...
                  <PlayerController index={index} isPaused={isPaused} isPlaying={isPlaying} setIsPaused={setIsPaused} setIsPlaying={setIsPlaying} />
                  <div>
